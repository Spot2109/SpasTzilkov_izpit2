...
namespace Testing
{
    ...
    public class UnitTest1
    {
        ...
        public void Setup()
        {
            ...
            Potrebitel user = new Potrebitel(0, "Orhan", "Murad", 21, "slepiqorel", "123456", "neshto_si@gmail.com", 0);
            ElUsero = user;
        }
        [TestCleanup]
        public void CleanUp()
        ...
        {
            var newuser = new Potrebitel(0, "Orhan", "Murad", 21, "slepiqorel", "123456", "neshto_si@gmail.com", 0);
